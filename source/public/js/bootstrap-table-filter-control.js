...
//                .text($('<div />').html(text).text()));
            ...
            if (value.indexOf('glyphicon-ok') !== -1)
                selectControl.append($("<option></option>")
                    .attr("value", value)
                    .text('✔'));
            else if (value.indexOf('glyphicon-remove') !== -1)
                selectControl.append($("<option></option>")
                    .attr("value", value)
                    .text('✖'));
            else if (value.indexOf("glyphicon-alert") !== -1)
                selectControl.append($("<option></option>")
                    .attr("value", value)
                    .text('⚠'));
            else if (value.indexOf("glyphicon-exclamation-sign") !== -1)
                selectControl.append($("<option></option>")
                    .attr("value", value)
                    .text('❆'));
            else
    ...
    var fixHeaderCSS = function (that) {
        if(that.$header.context['id']==='sample-table')
